...
//   title1: document.querySelector('.js-title1'),
//   title2: document.querySelector('.js-title2'),
// };

// const maxLength = 21;
// const totalLength = maxLength + 3;

// const onClickTitle = evt => {
...
//   } else if (title.hasAttribute('data-title')) {
...
// refs.title1.addEventListener('click', onClickTitle);
// refs.title2.addEventListener('click', onClickTitle);

// ====================================================================
// const refs = {
//   titleList: document.querySelectorAll('.js-title'),
// };

// const maxLength = 21;
// const totalLength = maxLength + 3;

// refs.titleList.forEach(title => {
